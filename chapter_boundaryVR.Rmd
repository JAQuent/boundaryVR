...
grid.arrange(grobs = list(gplot1, blank, legend, gplot2, gplot3, gplot4, blank),
             newpage = FALSE,
             top =  grid.text(expression("Design analysis with max sample size of 36 (d"[true]*" = 0.00)")),
             layout_matrix = lay,
             widths = c(12, 3, 2))
```
...
grid.arrange(grobs = list(gplot1, blank, legend, gplot2, gplot3, gplot4, blank),
             newpage = FALSE,
             top =  grid.text(expression("Design analysis with max sample size of 36 (d"[true]*" = 0.44)")),
             layout_matrix = lay,
             widths = c(12, 3, 2))
```
...
grid.arrange(grobs = list(gplot1, blank, legend, gplot2, gplot3, gplot4, blank),
             newpage = FALSE,
             top = grid.text(expression("Design analysis with max sample size of 36 (d"[true]*" = 0.78)")),
             layout_matrix = lay,
             widths = c(12, 3, 2))
```
